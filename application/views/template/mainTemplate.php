...
<html lang="en">
  <head>
    ...
    <!-- NProgress -->
    <link href="<?=base_url('resource/nprogress/nprogress.css');?>" rel="stylesheet">
  ...
  <body class="nav-md">
    ...
    <!-- Bootstrap -->
    <script src="<?=base_url('resource/bootstrap/dist/js/bootstrap.min.js');?>"></script>
    <!-- FastClick -->
    <script src="<?=base_url('resource/fastclick/lib/fastclick.js');?>"></script>
    <!-- NProgress -->
    <script src="<?=base_url('resource/nprogress/nprogress.js');?>"></script>
